...
<template>
	<div style="width: 730px;margin: 0px auto;">
		...
		<div style="text-align: left;margin-bottom: 20px;">
			...
			<el-button :disabled="ispower" @click='add'>增加</el-button>
		</div>
		<el-table :data="list" style='width: 730px;margin-bottom: 30px;'>
			...
			<el-table-column align='center' label="操作" width='100'>
				<template slot-scope="scope">
					...
					<el-button :disabled="ispower" size='small' type="text" @click="del(scope.row.compid)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
...
<script>
	export default {
		...
		methods: {
			...
			search() {
				// 后端网址
				var url = this.baseUrl + "/baseCompany/searchByPage"
				// 传递给后端的数据
				var data = {
